<?php $__env->startSection('title', __('views.admin.countries.index.title-restore')); ?>
        ...
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.countries.restore-country', [$country->id])); ?>"
                           data-toggle="tooltip" data-placement="top" data-title="<?php echo e(__('views.admin.countries.index.restore')); ?>">
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Feussom Ronald Jr\Documents\MONKEY TECH\GIS\Residat\web\resources\views/admin/countries/restore.blade.php ENDPATH**/ ?>