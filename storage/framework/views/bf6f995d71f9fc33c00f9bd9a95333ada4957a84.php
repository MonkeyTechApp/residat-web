...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td><?php if($zone->mother != null ): ?><?php echo e($zone->mother->name ?? 'No parent'); ?> <?php else: ?> <?php echo e(__('views.admin.no_parent')); ?> <?php endif; ?></td>
            </tr>
    ...
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <tbody>
            <?php $__currentLoopData = $zone->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($child->name); ?></td>
                    <td><?php echo e($child->mother->name ?? 'No parent'); ?></td>
                    <td><?php echo e($child->region->name ?? 'Unknown'); ?></td>
                    <td>
                        <?php if($child->active): ?>
                    ...
                    <td><?php echo e($child->created_at); ?></td>
                    <td><?php echo e($child->updated_at); ?></td>
                    <td>
                        <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.zones.show', [$child->id])); ?>" data-toggle="tooltip" data-placement="top" data-title="<?php echo e(__('views.admin.zones.index.show')); ?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.zones.edit', [$child->id])); ?>" data-toggle="tooltip" data-placement="top" data-title="<?php echo e(__('views.admin.zones.index.edit')); ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <?php if(\Illuminate\Support\Facades\Auth::user()->hasRole('administrator')): ?>
                            <a href="<?php echo e(route('admin.zones.destroy', [$child->id])); ?>" class="btn btn-xs btn-danger user_destroy" data-toggle="tooltip" data-placement="top" data-title="<?php echo e(__('views.admin.zones.index.delete')); ?>">
        ...
        <h4><?php echo e(__('views.admin.map', ['name' => $zone->name])); ?></h4>
        <?php echo $zone->svg; ?>
