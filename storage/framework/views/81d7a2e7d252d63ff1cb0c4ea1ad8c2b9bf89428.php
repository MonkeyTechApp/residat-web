            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li>
                        ...
                        <a href="<?php echo e(route('admin.countries.restore')); ?>">
                            <i class="fa fa-flag" aria-hidden="true"></i>
                        ...
                        <a href="<?php echo e(route('admin.regions')); ?>">
                            <i class="fa fa-flag-checkered" aria-hidden="true"></i>
                            <?php echo e(__('views.backend.section.navigation.menu_1_6')); ?>

                        </a>
                    </li><li>
                        <a href="<?php echo e(route('admin.regions.restore')); ?>">
                            <i class="fa fa-flag-checkered" aria-hidden="true"></i>
                            <i class="fa fa-refresh" aria-hidden="true"></i>
                        ...
                        <a href="<?php echo e(route('admin.zones')); ?>">
                            ...
                            <?php echo e(__('views.backend.section.navigation.menu_1_8')); ?>
...
<?php /**PATH C:\Users\Feussom Ronald Jr\Documents\MONKEY TECH\GIS\Residat\web\resources\views/admin/sections/navigation.blade.php ENDPATH**/ ?>